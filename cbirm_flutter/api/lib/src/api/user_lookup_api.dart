...
import 'package:blcirm_api/src/model/application_dtos_list_result_dto1_volo_abp_users_user_data.dart';
...
class UserLookupApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [UsersUserData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UsersUserData>> apiIdentityUsersLookupByUsernameUserNameGet({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UsersUserData),
            ) as UsersUserData;
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<int>> apiIdentityUsersLookupCountGet({
    String? filter,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [UsersUserData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UsersUserData>> apiIdentityUsersLookupIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/identity/users/lookup/{id}'
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApplicationDtosListResultDto1VoloAbpUsersUserData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ApplicationDtosListResultDto1VoloAbpUsersUserData>>
      apiIdentityUsersLookupSearchGet({
    String? filter,
    String? sorting,
    int? skipCount,
    ...
    ApplicationDtosListResultDto1VoloAbpUsersUserData? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as ApplicationDtosListResultDto1VoloAbpUsersUserData;
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApplicationDtosListResultDto1VoloAbpUsersUserData>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
