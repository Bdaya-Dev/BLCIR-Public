...
import 'package:blcirm_api/src/model/application_dtos_paged_result_dto1_bdaya_blcirm_state_person_dto.dart';
...
class PeopleApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApplicationDtosPagedResultDto1BdayaBLCIRMStatePersonDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ApplicationDtosPagedResultDto1BdayaBLCIRMStatePersonDto>>
      apiAppPeopleGet({
    String? sorting,
    int? skipCount,
    int? maxResultCount,
    ...
    ApplicationDtosPagedResultDto1BdayaBLCIRMStatePersonDto? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as ApplicationDtosPagedResultDto1BdayaBLCIRMStatePersonDto;
    ...
    return Response<ApplicationDtosPagedResultDto1BdayaBLCIRMStatePersonDto>(
      data: _responseData,
  ...
  Future<Response<BdayaBLCIRMStateTransactionProposalDto>>
    ...
    final _path =
        r'/api/app/people/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BdayaBLCIRMStatePersonDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BdayaBLCIRMStatePersonDto>> apiAppPeopleIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BdayaBLCIRMStatePersonDto? _responseData;
    ...
    return Response<BdayaBLCIRMStatePersonDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BdayaBLCIRMStateTransactionProposalDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BdayaBLCIRMStateTransactionProposalDto>> apiAppPeopleIdPut({
    required String id,
    BdayaBLCIRMStatePeopleCreatePersonDto?
        bdayaBLCIRMStatePeopleCreatePersonDto,
    CancelToken? cancelToken,
    ...
    try {
      const _type = FullType(BdayaBLCIRMStatePeopleCreatePersonDto);
      _bodyData = bdayaBLCIRMStatePeopleCreatePersonDto == null
          ? null
          : _serializers.serialize(bdayaBLCIRMStatePeopleCreatePersonDto,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
  ...
  /// Returns a [Future] containing a [Response] with a [BdayaBLCIRMStateTransactionProposalDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BdayaBLCIRMStateTransactionProposalDto>> apiAppPeoplePost({
    BdayaBLCIRMStatePeopleCreatePersonDto?
        bdayaBLCIRMStatePeopleCreatePersonDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
