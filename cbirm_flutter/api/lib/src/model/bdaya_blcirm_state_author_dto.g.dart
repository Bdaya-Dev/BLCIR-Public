...
part of 'bdaya_blcirm_state_author_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$BdayaBLCIRMStateAuthorDto extends BdayaBLCIRMStateAuthorDto {
  @override
  final String? id;
  @override
  ...
  factory _$BdayaBLCIRMStateAuthorDto(
          [void Function(BdayaBLCIRMStateAuthorDtoBuilder)? updates]) =>
      (new BdayaBLCIRMStateAuthorDtoBuilder()..update(updates))._build();

  _$BdayaBLCIRMStateAuthorDto._(
      {this.id,
      this.creationTime,
      this.creatorId,
  ...
  @override
  BdayaBLCIRMStateAuthorDto rebuild(
          void Function(BdayaBLCIRMStateAuthorDtoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BdayaBLCIRMStateAuthorDtoBuilder toBuilder() =>
      new BdayaBLCIRMStateAuthorDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BdayaBLCIRMStateAuthorDto &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BdayaBLCIRMStateAuthorDto')
          ..add('id', id)
...
class BdayaBLCIRMStateAuthorDtoBuilder
    implements
        Builder<BdayaBLCIRMStateAuthorDto, BdayaBLCIRMStateAuthorDtoBuilder>,
        BdayaBLCIRMStatePersonDtoBuilder {
  _$BdayaBLCIRMStateAuthorDto? _$v;
  ...
  BdayaBLCIRMStateAuthorDtoBuilder() {
    BdayaBLCIRMStateAuthorDto._defaults(this);
  }

  BdayaBLCIRMStateAuthorDtoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(covariant BdayaBLCIRMStateAuthorDto other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$BdayaBLCIRMStateAuthorDto;
  }

  @override
  void update(void Function(BdayaBLCIRMStateAuthorDtoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BdayaBLCIRMStateAuthorDto build() => _build();

  _$BdayaBLCIRMStateAuthorDto _build() {
    _$BdayaBLCIRMStateAuthorDto _$result;
    try {
      _$result = _$v ??
          new _$BdayaBLCIRMStateAuthorDto._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'BdayaBLCIRMStateAuthorDto', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
