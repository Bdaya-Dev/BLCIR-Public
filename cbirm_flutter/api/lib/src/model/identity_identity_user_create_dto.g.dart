...
part of 'identity_identity_user_create_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$IdentityIdentityUserCreateDto extends IdentityIdentityUserCreateDto {
  @override
  ...
  factory _$IdentityIdentityUserCreateDto(
          [void Function(IdentityIdentityUserCreateDtoBuilder)? updates]) =>
      (new IdentityIdentityUserCreateDtoBuilder()..update(updates))._build();

  _$IdentityIdentityUserCreateDto._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        password, r'IdentityIdentityUserCreateDto', 'password');
    BuiltValueNullFieldError.checkNotNull(
        userName, r'IdentityIdentityUserCreateDto', 'userName');
    BuiltValueNullFieldError.checkNotNull(
        email, r'IdentityIdentityUserCreateDto', 'email');
  }

  @override
  IdentityIdentityUserCreateDto rebuild(
          void Function(IdentityIdentityUserCreateDtoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  IdentityIdentityUserCreateDtoBuilder toBuilder() =>
      new IdentityIdentityUserCreateDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is IdentityIdentityUserCreateDto &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'IdentityIdentityUserCreateDto')
...
class IdentityIdentityUserCreateDtoBuilder
    implements
        Builder<IdentityIdentityUserCreateDto,
            IdentityIdentityUserCreateDtoBuilder>,
        IdentityIdentityUserCreateOrUpdateDtoBaseBuilder {
  _$IdentityIdentityUserCreateDto? _$v;
  ...
  IdentityIdentityUserCreateDtoBuilder() {
    IdentityIdentityUserCreateDto._defaults(this);
  }

  IdentityIdentityUserCreateDtoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant IdentityIdentityUserCreateDto other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$IdentityIdentityUserCreateDto;
  }

  @override
  void update(void Function(IdentityIdentityUserCreateDtoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  IdentityIdentityUserCreateDto build() => _build();

  _$IdentityIdentityUserCreateDto _build() {
    _$IdentityIdentityUserCreateDto _$result;
    try {
      _$result = _$v ??
          new _$IdentityIdentityUserCreateDto._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'IdentityIdentityUserCreateDto', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
